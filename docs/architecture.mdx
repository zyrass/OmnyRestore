...
erDiagram
    ...
    ORDER_DELIVERIES {
        ...
        timestamp zip_expires_at "90 days TTL (NEW)"
        timestamp created_at
    }
...
sequenceDiagram
    ...
    Livewire-->>Browser: Verdict IA + prix (1|2|3 € TTC/photo)
...
stateDiagram-v2
    ...
    PAID --> DELIVERED : GenerateOrderZipJob & Client Delivery
    ...
    note right of DELIVERED
        ...
        → Audit log: DOWNLOAD (upon access)
        → ZIP auto-expires in 90 days
    end note
```
...
GET /client/orders/{id}/download
    ...
    → Verify zip_expires_at is not past 90 days
...
| A11 | Security Headers | `SecurityHeaders` middleware: HSTS, CSP, X-Frame-Options |
