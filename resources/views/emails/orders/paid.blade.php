...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* Badge succès */
        .badge { display: inline-block; background: rgba(52,211,153,0.1); border: 1px solid rgba(52,211,153,0.3); color: #34D399; font-size: 11px; font-weight: 600; letter-spacing: 2px; text-transform: uppercase; padding: 6px 16px; border-radius: 100px; margin-bottom: 24px; }
        ...
        .order-box { background: #0F0C08; border: 1px solid rgba(201,168,76,0.15); border-radius: 4px; padding: 30px; margin: 32px 0; }
        ...
        .prep-box { background: rgba(201,168,76,0.03); border: 1px solid rgba(201,168,76,0.1); border-left: 3px solid #C9A84C; padding: 20px 24px; margin: 32px 0; }
        .prep-title { color: #C9A84C; font-size: 13px; font-weight: bold; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 8px; }
        .prep-text { font-size: 14px; color: #9E9085; line-height: 1.6; }
...
<div class="container">
    <div class="header">
        ...
        <h1>Merci pour votre<br>confiance !</h1>
    </div>
    ...
    <div class="body">
        ...
        <p class="text">
            Nous vous confirmons la bonne réception de votre paiement pour la commande <strong>{{ $order->reference }}</strong>. Toute l'équipe d'OmnyRestore vous remercie !
        </p>
        ...
        <div class="order-box">
            ...
            <div class="order-box-total">
                ...
                <span class="order-box-total-value">
                    {{ number_format($order->getAmountTtcCents() / 100, 2, ',', ' ') }} € <span style="font-size: 12px; color: #7A6E5E; font-weight: normal;">TTC</span>
                </span>
            </div>
        </div>
