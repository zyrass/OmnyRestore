...
<div class="container">
    <div class="header" style="text-align: center;">
        ...
        <div class="badge" style="display: inline-block; background: rgba(201,168,76,0.08); border: 1px solid rgba(201,168,76,0.25); color: #C9A84C; font-size: 11px; font-weight: 600; letter-spacing: 2px; text-transform: uppercase; padding: 6px 16px; border-radius: 100px; margin-bottom: 24px; text-align: center;">Cadeau Fidélité</div>
        <h1 style="text-align: center; font-family: Georgia, 'Times New Roman', serif; font-size: 28px; color: #F5F0E8; font-weight: normal; line-height: 1.3; margin-bottom: 12px; margin-top: 0;">Merci pour votre<br>fidélité !</h1>
    </div>
