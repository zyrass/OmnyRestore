...
<body class="min-h-screen flex antialiased">
    ...
    <div class="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-[#0D0B08] flex-col justify-between p-12">
        ...
        <div class="relative z-10 flex items-center gap-6">
            ...
            <div class="flex items-center gap-2">
                ...
                <span class="text-[#7A6E5E] text-xs">Qualité 8K</span>
            </div>
        </div>
    </div>

    {{-- ── Colonne droite : formulaire ─────────────────────────────────────── --}}
    <div class="flex-1 lg:w-1/2 flex flex-col justify-center items-center min-h-screen bg-[#0D0B08] px-6 py-12 relative">
