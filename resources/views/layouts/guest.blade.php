        ...
        <div class="bg-[#0A0804] py-5">
            <div class="max-w-6xl mx-auto px-8 flex flex-col sm:flex-row items-center justify-between gap-3">
                ...
                <div class="flex flex-wrap justify-center gap-5 text-[#7A6E5E] text-xs">
                    ...
                    <a href="{{ route('legal.privacy') }}" wire:navigate class="hover:text-[#C9A84C] transition-colors flex items-center gap-1.5">
                        <span class="w-1 h-1 rounded-full bg-[#C9A84C]/30 shrink-0"></span>Confidentialité
                    </a>
                    <a href="{{ route('legal.cgv') }}" wire:navigate class="hover:text-[#C9A84C] transition-colors flex items-center gap-1.5">
