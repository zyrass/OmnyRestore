...
<div>
    <div class="mb-8">
        <h1 class="text-2xl font-bold text-[#F5F0E8] mb-2 flex items-center gap-3">
            ...
            {{ Auth::user()->role === 'super-admin' ? 'Mon Espace Admin' : (Auth::user()->role === 'operator' ? 'Mon Espace Opérateur' : (Auth::user()->role === 'rh' ? 'Mon Espace Ressources Humaines' : 'Mon Espace Marketing')) }}
        </h1>
