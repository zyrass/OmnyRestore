...
<div>
    <form wire:submit="resetPassword">
        ...
        <div class="mt-4" x-data="{ show: false }">
            ...
            <div class="relative">
                <x-text-input wire:model="password" id="password" class="block mt-1 w-full pr-12" x-bind:type="show ? 'text' : 'password'" name="password" required autocomplete="new-password" />
        ...
        <div class="mt-4" x-data="{ show: false }">
            ...
            <div class="relative">
                <x-text-input wire:model="password_confirmation" id="password_confirmation" class="block mt-1 w-full pr-12"
