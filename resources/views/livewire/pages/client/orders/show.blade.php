        ...
        <div class="space-y-5">
            ...
            <div class="card-glass p-5 bg-[#1A1510]/50">
                ...
                <p class="text-[#7A6E5E] text-xs leading-relaxed mb-3">
                    Notre équipe est disponible par email pour toute question concernant votre commande.
                </p>
                <a href="mailto:contact@omnyrestore.fr?subject=Commande {{ $order->reference }}"
                   class="text-[#C9A84C] text-xs hover:text-[#E8C97A] transition-colors underline underline-offset-2">
