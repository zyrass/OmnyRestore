    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="card-glass p-8 text-center border-[#C9A84C]/30">
                ...
                {{-- Facture PDF --}}
                <div class="mt-5 pt-5 border-t border-[#C9A84C]/10 flex items-center justify-center gap-4">
                    <a href="{{ route('client.orders.invoice', $order) }}" target="_blank"
                       class="inline-flex items-center gap-2 text-sm text-[#7A6E5E] hover:text-[#C9A84C] transition-colors">
