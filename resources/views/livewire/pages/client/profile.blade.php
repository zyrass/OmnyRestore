            ...
            <div class="card-glass p-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    @foreach([
                        ...
                        ['icon' => 'M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4', 'title' => 'Droit à la portabilité', 'desc' => 'Exporter vos données (Format standard)'],
                    ] as $right)
                ...
                <div class="mt-4 pt-4 border-t border-[#C9A84C]/10 space-y-2">
                    <p class="text-[#7A6E5E] text-xs">
                        Pour exercer vos droits (hors suppression) :
                    ...
                    <p class="text-[#7A6E5E] text-xs">
                        <strong class="text-[#F5F0E8]">Droit à l'effacement :</strong> Il est exécuté <strong class="text-emerald-400">instantanément</strong> dans la seconde où vous supprimez votre compte depuis la zone critique ci-contre (bien que le délai légal maximum soit d'un mois).
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="space-y-5">
            ...
            <div class="card-glass p-5 border-[#C9A84C]/15 mb-5">
                ...
                <p class="text-[#7A6E5E] text-xs mb-4">
                    Cet export vous fournit vos données personnelles textuelles (coordonnées, métadonnées de commandes) au format brut <strong>JSON</strong>. 
                    <br><br>
                    <span class="text-[#C9A84C]/80 italic">Note : Vos factures (PDF) et photographies restaurées doivent être téléchargées individuellement depuis la page "Mes commandes".</span>
                </p>
